...
import com.example.place_suggestor.util.TimeKeeper;
...
public class ModelFactory {
    ...
    private static Double getError(JavaRDD<Rating> testRdd, int rank, int iterationsNr, JavaRDD<Tuple2<Object, Object>> testForPredict,
                                   TimeKeeper timeKeeper, MatrixFactorizationModel model) {
        timeKeeper.start();
